...
import org.apache.spark.rdd.RDD
def ComputeFeaturesDistinctInfo(attributesRdd:RDD[TableObject_AverageMonthVolume_percent]
...
def ConvertZipRDDItem2LabeledPoint(point:org.apache.spark.rdd.RDD[(TableObject_AverageMonthVolume_percent, Int)]):LabeledPoint = {
  val item = point._1
  val label = point._2
