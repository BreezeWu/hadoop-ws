...
// 一年各月用电量(Array)
case class TwelveVolumes(data:IndexedSeq[Double]) //Array[Double]

// 逐年的月用电量
//case class YearsVolumes(y2010:IndexedSeq[Double], y2011:IndexedSeq[Double], y2012:IndexedSeq[Double], y2013:IndexedSeq[Double], y2014:IndexedSeq[Double])
