...
//		http://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/binary.html#a8a
//		http://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/binary.html#a8a.t
//
//	调整后的数据来源: 
//		http://statweb.stanford.edu/~tibs/ElemStatLearn/datasets/spam.data
//		http://statweb.stanford.edu/~tibs/ElemStatLearn/datasets/spam.traintest

// 上传数据到HDFS
//	 hdfs dfs -put a8a* dm-data/spark-data/
...
//      println("iteration " + i + ": w = " + w)  
  ...
  def main(args: Array[String]): Unit = {  
    ...
    //val trainfile = "dm-data/spark-data/spam.data";  
    val trainfile = "dm-data/spark-data/a8a.train"; 
    ...
    //val testfile = "dm-data/spark-data/spam.traintest"; 
    val testfile = "dm-data/spark-data/a8a.test";   
