 ...
 *
 * 引入
 *      :load  /home/hadoop/workspace_github/hadoop-ws/spark-ws/MLlib/volumeprice-mining/transformations-of-volumeprice-ERROR.scala
 *
...
def row2Item_of_ladder(r:org.apache.spark.sql.Row):Item_of_ladder = {
    ...
    new Item_of_ladder(Any2String(r(0)), Any2String(r(1)),
...
def row2Item_of_ts(r:org.apache.spark.sql.Row):Item_of_ts = {
    ...
    new Item_of_ts(Any2String(r(0)), Any2String(r(1)),
