...
// 1. 有效数据
// 单月
val rddFromHiveIndexed_GoodM1  = hiveContext.hql(s"SELECT ${idInfo},${vpmStrOf2013} FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE_GOOD_M1")
// 双月
val rddFromHiveIndexed_GoodM2  = hiveContext.hql(s"SELECT ${idInfo},${vpmStrOf2013} FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE_GOOD_M2")

// 2. 无效数据
// 前3各月都是 0/NULL
val rddFromHiveIndexed_BadF3  = hiveContext.hql(s"SELECT ${idInfo},${vpmStrOf2013} FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE_ZERO_AND_NULL_F3")
// 仅前两个月都是 0或NULL
val rddFromHiveIndexed_BadF2ExcludeF3  = hiveContext.hql(s"SELECT ${idInfo},${vpmStrOf2013} FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE_ZERO_AND_NULL_F2_EXCLUDE_F3") 
