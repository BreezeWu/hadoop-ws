...
// val rddFromHiveM1 = hiveContext.hql("SELECT  vpm201301,vpm201302,vpm201303,vpm201304,vpm201305,vpm201306,vpm201307,vpm201308,vpm201309,vpm201310,vpm201311,vpm201312,rcved_amt201301,rcved_amt201302,rcved_amt201303,rcved_amt201304,rcved_amt201305,rcved_amt201306,rcved_amt201307,rcved_amt201308,rcved_amt201309,rcved_amt201310,rcved_amt201311,rcved_amt201312,rcvbl_amt201301,rcvbl_amt201302,rcvbl_amt201303,rcvbl_amt201304,rcvbl_amt201305,rcvbl_amt201306,rcvbl_amt201307,rcvbl_amt201308,rcvbl_amt201309,rcvbl_amt201310,rcvbl_amt201311,rcvbl_amt201312,owning_amt201301,owning_amt201302,owning_amt201303,owning_amt201304,owning_amt201305,owning_amt201306,owning_amt201307,owning_amt201308,owning_amt201309,owning_amt201310,owning_amt201311,owning_amt201312  FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE x where (org_no !like '21401%' and org_no !like '21408%') and status_code != 9")

// 获取 月用电量(vpm)
val rddFromHiveM1 = hiveContext.hql("SELECT  vpm201301,vpm201302,vpm201303,vpm201304,vpm201305,vpm201306,vpm201307,vpm201308,vpm201309,vpm201310,vpm201311,vpm201312 FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE x where (org_no !like '21401%' and org_no !like '21408%') and status_code != 9")

// 获取 月用电量(vpm) 年度汇总
//val rddFromHiveM1 = hiveContext.hql("SELECT sum(vpm201301,vpm201302,vpm201303,vpm201304,vpm201305,vpm201306,vpm201307,vpm201308,vpm201309,vpm201310,vpm201311,vpm201312)  FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE x where (org_no !like '21401%' and org_no !like '21408%') and status_code != 9")

// ----------------------------------------------------------------------------
// 双月数据 m2

// 获取 月用电量(vpm), 实收(rcved_amt), 应收(rcvbl_amt), 欠费(owning_amt)
//val rddFromHiveM2 = hiveContext.hql("SELECT  vpm201301,vpm201302,vpm201303,vpm201304,vpm201305,vpm201306,vpm201307,vpm201308,vpm201309,vpm201310,vpm201311,vpm201312,rcved_amt201301,rcved_amt201302,rcved_amt201303,rcved_amt201304,rcved_amt201305,rcved_amt201306,rcved_amt201307,rcved_amt201308,rcved_amt201309,rcved_amt201310,rcved_amt201311,rcved_amt201312,rcvbl_amt201301,rcvbl_amt201302,rcvbl_amt201303,rcvbl_amt201304,rcvbl_amt201305,rcvbl_amt201306,rcvbl_amt201307,rcvbl_amt201308,rcvbl_amt201309,rcvbl_amt201310,rcvbl_amt201311,rcvbl_amt201312,owning_amt201301,owning_amt201302,owning_amt201303,owning_amt201304,owning_amt201305,owning_amt201306,owning_amt201307,owning_amt201308,owning_amt201309,owning_amt201310,owning_amt201311,owning_amt201312  FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE x where (org_no like '21401%' or org_no like '21408%') and status_code != 9")

// 获取 月用电量(vpm)
val rddFromHiveM2 = hiveContext.hql("SELECT  vpm201301,vpm201302,vpm201303,vpm201304,vpm201305,vpm201306,vpm201307,vpm201308,vpm201309,vpm201310,vpm201311,vpm201312 FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE x where (org_no like '21401%' or org_no like '21408%') and status_code != 9")
