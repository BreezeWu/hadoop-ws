...
// ----------------------------------------------------------------------------
/*
-- 单月数据	BIGDATA_USER_INFO_S98_ONEBIGTABLE_M1
-- 双月数据	BIGDATA_USER_INFO_S98_ONEBIGTABLE_M2
*/
...
// 原始数据
// 单月数据 月用电量(vpm)
val rddFromHiveM1 = hiveContext.hql(s"SELECT ${vpmStrOf2013} FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE_M1")

// 双月数据 月用电量(vpm)
val rddFromHiveM2 = hiveContext.hql(s"SELECT ${vpmStrOf2013} FROM BIGDATA_USER_INFO_S98_ONEBIGTABLE_M2")
