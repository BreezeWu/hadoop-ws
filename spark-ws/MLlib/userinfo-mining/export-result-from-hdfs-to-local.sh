...
hdfs dfs -cat hdfs://master-hadoop:9000/${RESULT_FILE_PATH_0}/* > ${RESULT_DATA_LOCAL_FILEPATH}/metrics${RESULT_DESC_0}.csv
hdfs dfs -cat hdfs://master-hadoop:9000/${RESULT_FILE_PATH_1}/* > ${RESULT_DATA_LOCAL_FILEPATH}/metrics${RESULT_DESC_1}.csv
