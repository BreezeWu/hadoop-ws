...
-- ## 用户信息表 BIGDATA_USER_INFO_S98
-- ## 月用电量 BIGDATA_ARC_VOLUME_PERM_S98
-- ## 用户逐月缴费欠费信息 BIGDATA_RCVBL_FLOW_PM_S98
-- ## 违约用电次数 BIGDATA_POWER_STEAL_PERY_S98
-- ## 是否阶梯电价 BIGDATA_TS_OR_PRCSCOPE_S98
...
select x.cons_id,ym1301.vpm201301,ym1302.vpm201302,ym1303.vpm201303,ym1304.vpm201304,ym1305.vpm201305,ym1306.vpm201306,ym1307.vpm201307,ym1308.vpm201308,ym1309.vpm201309,ym1310.vpm201310,ym1311.vpm201311,ym1312.vpm201312 from (select distinct(cons_id) from BIGDATA_ARC_VOLUME_PERM_S98) x
    ...
    left outer join (select cons_id, volume_per_month as vpm201302 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201302') ym1302 on ym1302.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201303 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201303') ym1303 on ym1303.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201304 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201304') ym1304 on ym1304.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201305 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201305') ym1305 on ym1305.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201306 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201306') ym1306 on ym1306.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201307 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201307') ym1307 on ym1307.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201308 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201308') ym1308 on ym1308.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201309 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201309') ym1309 on ym1309.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201310 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201310') ym1310 on ym1310.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201311 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201311') ym1311 on ym1311.cons_id = x.cons_id
    left outer join (select cons_id, volume_per_month as vpm201312 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201312') ym1312 on ym1312.cons_id = x.cons_id
;


--    left outer join (select cons_id, volume_per_month as vpm201401 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201401') ym1401 on ym1401.cons_id = x.cons_id
--    left outer join (select cons_id, volume_per_month as vpm201402 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201402') ym1402 on ym1402.cons_id = x.cons_id
--    left outer join (select cons_id, volume_per_month as vpm201403 from BIGDATA_ARC_VOLUME_PERM_S98 where ym = '201403') ym1403 on ym1403.cons_id = x.cons_id
...
CREATE TABLE BIGDATA_RCVBL_FLOW_PM_S98_H AS 
 select x.cons_no, ym201301.rcved_amt201301,ym201302.rcved_amt201302,ym201303.rcved_amt201303,ym201304.rcved_amt201304,ym201305.rcved_amt201305,ym201306.rcved_amt201306,ym201307.rcved_amt201307,ym201308.rcved_amt201308,ym201309.rcved_amt201309,ym201310.rcved_amt201310,ym201311.rcved_amt201311,ym201312.rcved_amt201312,ym201301.rcvbl_amt201301,ym201302.rcvbl_amt201302,ym201303.rcvbl_amt201303,ym201304.rcvbl_amt201304,ym201305.rcvbl_amt201305,ym201306.rcvbl_amt201306,ym201307.rcvbl_amt201307,ym201308.rcvbl_amt201308,ym201309.rcvbl_amt201309,ym201310.rcvbl_amt201310,ym201311.rcvbl_amt201311,ym201312.rcvbl_amt201312,ym201301.owning_amt201301,ym201302.owning_amt201302,ym201303.owning_amt201303,ym201304.owning_amt201304,ym201305.owning_amt201305,ym201306.owning_amt201306,ym201307.owning_amt201307,ym201308.owning_amt201308,ym201309.owning_amt201309,ym201310.owning_amt201310,ym201311.owning_amt201311,ym201312.owning_amt201312 from (select distinct(cons_no) from BIGDATA_RCVBL_FLOW_PM_S98) x 
    ...
    left outer join (select cons_no, rcved_amt as rcved_amt201302, rcvbl_amt as rcvbl_amt201302, owning_amt as owning_amt201302 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201302') ym201302 on ym201302.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201303, rcvbl_amt as rcvbl_amt201303, owning_amt as owning_amt201303 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201303') ym201303 on ym201303.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201304, rcvbl_amt as rcvbl_amt201304, owning_amt as owning_amt201304 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201304') ym201304 on ym201304.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201305, rcvbl_amt as rcvbl_amt201305, owning_amt as owning_amt201305 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201305') ym201305 on ym201305.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201306, rcvbl_amt as rcvbl_amt201306, owning_amt as owning_amt201306 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201306') ym201306 on ym201306.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201307, rcvbl_amt as rcvbl_amt201307, owning_amt as owning_amt201307 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201307') ym201307 on ym201307.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201308, rcvbl_amt as rcvbl_amt201308, owning_amt as owning_amt201308 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201308') ym201308 on ym201308.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201309, rcvbl_amt as rcvbl_amt201309, owning_amt as owning_amt201309 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201309') ym201309 on ym201309.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201310, rcvbl_amt as rcvbl_amt201310, owning_amt as owning_amt201310 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201310') ym201310 on ym201310.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201311, rcvbl_amt as rcvbl_amt201311, owning_amt as owning_amt201311 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201311') ym201311 on ym201311.cons_no = x.cons_no
    left outer join (select cons_no, rcved_amt as rcved_amt201312, rcvbl_amt as rcvbl_amt201312, owning_amt as owning_amt201312 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201312') ym201312 on ym201312.cons_no = x.cons_no
;

--    left outer join (select cons_no, rcved_amt as rcved_amt201401, rcvbl_amt as rcvbl_amt201401, owning_amt as owning_amt201401 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201401') ym201401 on ym201401.cons_no = x.cons_no
--    left outer join (select cons_no, rcved_amt as rcved_amt201402, rcvbl_amt as rcvbl_amt201402, owning_amt as owning_amt201402 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201402') ym201402 on ym201402.cons_no = x.cons_no
--    left outer join (select cons_no, rcved_amt as rcved_amt201403, rcvbl_amt as rcvbl_amt201403, owning_amt as owning_amt201403 from BIGDATA_RCVBL_FLOW_PM_S98 where ym = '201403') ym201403 on ym201403.cons_no = x.cons_no
