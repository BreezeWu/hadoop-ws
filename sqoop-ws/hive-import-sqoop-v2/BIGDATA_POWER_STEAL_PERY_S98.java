// ORM class for table 'BIGDATA_POWER_STEAL_PERY_S98'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Jul 08 14:28:11 CST 2014
...
public class BIGDATA_POWER_STEAL_PERY_S98 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public BIGDATA_POWER_STEAL_PERY_S98 with_用户ID(java.math.BigDecimal 用户ID) {
    this.用户ID = 用户ID;
    return this;
  }
  private String 年份;
  ...
  public BIGDATA_POWER_STEAL_PERY_S98 with_年份(String 年份) {
    this.年份 = 年份;
    return this;
  }
  private java.math.BigDecimal 违约用电次数;
  public java.math.BigDecimal get_违约用电次数() {
    return 违约用电次数;
  }
  public void set_违约用电次数(java.math.BigDecimal 违约用电次数) {
    this.违约用电次数 = 违约用电次数;
  }
  public BIGDATA_POWER_STEAL_PERY_S98 with_违约用电次数(java.math.BigDecimal 违约用电次数) {
    this.违约用电次数 = 违约用电次数;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BIGDATA_POWER_STEAL_PERY_S98)) {
      return false;
    }
    BIGDATA_POWER_STEAL_PERY_S98 that = (BIGDATA_POWER_STEAL_PERY_S98) o;
    boolean equal = true;
    ...
    equal = equal && (this.违约用电次数 == null ? that.违约用电次数 == null : this.违约用电次数.equals(that.违约用电次数));
    return equal;
  }
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.违约用电次数 = JdbcWritableBridge.readBigDecimal(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(违约用电次数, 3 + __off, 2, __dbStmt);
    return 3;
  }
  public void readFields(DataInput __dataIn) throws IOException {
    ...
    this.违约用电次数 = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.违约用电次数) { 
        ...
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.违约用电次数, __dataOut);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(违约用电次数==null?"null":违约用电次数.toPlainString(), delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.违约用电次数 = null; } else {
      this.违约用电次数 = new java.math.BigDecimal(__cur_str);
    }

  }

  public Object clone() throws CloneNotSupportedException {
    BIGDATA_POWER_STEAL_PERY_S98 o = (BIGDATA_POWER_STEAL_PERY_S98) super.clone();
    return o;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("违约用电次数", this.违约用电次数);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("违约用电次数".equals(__fieldName)) {
      this.违约用电次数 = (java.math.BigDecimal) __fieldVal;
    }
    else {
