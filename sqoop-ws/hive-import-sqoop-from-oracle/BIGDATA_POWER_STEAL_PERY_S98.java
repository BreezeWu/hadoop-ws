...
//
// Debug information:
// Generated date: Wed Jul 09 14:50:17 CST 2014
...
public class BIGDATA_POWER_STEAL_PERY_S98 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public BIGDATA_POWER_STEAL_PERY_S98 with_CONS_ID(java.math.BigDecimal CONS_ID) {
    this.CONS_ID = CONS_ID;
    return this;
  }
  private String Y;
  ...
  public BIGDATA_POWER_STEAL_PERY_S98 with_Y(String Y) {
    this.Y = Y;
    return this;
  }
  private java.math.BigDecimal INSPECT_COUNT;
  public java.math.BigDecimal get_INSPECT_COUNT() {
    return INSPECT_COUNT;
  }
  public void set_INSPECT_COUNT(java.math.BigDecimal INSPECT_COUNT) {
    this.INSPECT_COUNT = INSPECT_COUNT;
  }
  public BIGDATA_POWER_STEAL_PERY_S98 with_INSPECT_COUNT(java.math.BigDecimal INSPECT_COUNT) {
    this.INSPECT_COUNT = INSPECT_COUNT;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.INSPECT_COUNT = JdbcWritableBridge.readBigDecimal(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(INSPECT_COUNT, 3 + __off, 2, __dbStmt);
    return 3;
  }
  public void readFields(DataInput __dataIn) throws IOException {
    ...
    this.INSPECT_COUNT = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.INSPECT_COUNT) { 
        ...
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.INSPECT_COUNT, __dataOut);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(INSPECT_COUNT==null?"null":INSPECT_COUNT.toPlainString(), delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.INSPECT_COUNT = null; } else {
      this.INSPECT_COUNT = new java.math.BigDecimal(__cur_str);
    }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("CONS_ID".equals(__fieldName)) {
      ...
      this.INSPECT_COUNT = (java.math.BigDecimal) __fieldVal;
    }
    else {
