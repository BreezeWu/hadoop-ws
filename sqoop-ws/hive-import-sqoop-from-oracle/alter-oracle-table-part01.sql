...
alter table BIGDATA_USER_INFO_S98 rename column 用电性质  to tmp_ydxz;
alter table BIGDATA_USER_INFO_S98 rename column 供电电压  to tmp_volt_code;
alter table BIGDATA_USER_INFO_S98 rename column 负荷类型  to lode_attr_code;
alter table BIGDATA_USER_INFO_S98 rename column 城镇用户农村用户  to urban_rural_flag;
alter table BIGDATA_USER_INFO_S98 rename column 出账周期  to tmp_czzq;
alter table BIGDATA_USER_INFO_S98 rename column 高压低压  to cust_type_code;
...
alter table BIGDATA_TS_OR_PRCSCOPE_S98 rename column ladder_flag_int  to ladder_flag_i;
...
select  TS_FLAG,LADDER_FLAG from BIGDATA_TS_OR_PRCSCOPE_S98 where rownum < 10;

-- -----------------------------------------------------------------------------
-- 见 alter-oracle-table-part02.sql
-- 分时电价电量    ---表不存在
