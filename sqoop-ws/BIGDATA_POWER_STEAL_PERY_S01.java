...
//
// Debug information:
// Generated date: Fri Jul 04 16:47:02 CST 2014
...
public class BIGDATA_POWER_STEAL_PERY_S01 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public BIGDATA_POWER_STEAL_PERY_S01 with_用户ID(java.math.BigDecimal 用户ID) {
    this.用户ID = 用户ID;
    return this;
  }
  private String 年份;
  ...
  public BIGDATA_POWER_STEAL_PERY_S01 with_年份(String 年份) {
    this.年份 = 年份;
    return this;
  }
  ...
  public BIGDATA_POWER_STEAL_PERY_S01 with_违约用电次数(java.math.BigDecimal 违约用电次数) {
    this.违约用电次数 = 违约用电次数;
    return this;
  }
