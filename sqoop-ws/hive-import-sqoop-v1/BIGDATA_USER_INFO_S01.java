// ORM class for table 'BIGDATA_USER_INFO_S01'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Jul 04 16:28:43 CST 2014
...
public class BIGDATA_USER_INFO_S01 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public BIGDATA_USER_INFO_S01 with_用户ID(java.math.BigDecimal 用户ID) {
    this.用户ID = 用户ID;
    return this;
  }
  private String 客户名称;
  ...
  public BIGDATA_USER_INFO_S01 with_客户名称(String 客户名称) {
    this.客户名称 = 客户名称;
    return this;
  }
  private String 电价代码;
  ...
  public BIGDATA_USER_INFO_S01 with_电价代码(String 电价代码) {
    this.电价代码 = 电价代码;
    return this;
  }
  ...
  public BIGDATA_USER_INFO_S01 with_地市局编码(String 地市局编码) {
    this.地市局编码 = 地市局编码;
    return this;
  }
  private String 用电性质;
  ...
  public BIGDATA_USER_INFO_S01 with_用电性质(String 用电性质) {
    this.用电性质 = 用电性质;
    return this;
  }
  private String 用电类别;
  ...
  public BIGDATA_USER_INFO_S01 with_用电类别(String 用电类别) {
    this.用电类别 = 用电类别;
    return this;
  }
  private String 供电电压;
  ...
  public BIGDATA_USER_INFO_S01 with_供电电压(String 供电电压) {
    this.供电电压 = 供电电压;
    return this;
  }
  ...
  public BIGDATA_USER_INFO_S01 with_合同容量(java.math.BigDecimal 合同容量) {
    this.合同容量 = 合同容量;
    return this;
  }
  private String 负荷类型;
  ...
  public BIGDATA_USER_INFO_S01 with_负荷类型(String 负荷类型) {
    this.负荷类型 = 负荷类型;
    return this;
  }
  ...
  public BIGDATA_USER_INFO_S01 with_当前是否销户(String 当前是否销户) {
    this.当前是否销户 = 当前是否销户;
    return this;
  }
  ...
  public BIGDATA_USER_INFO_S01 with_城镇用户农村用户(String 城镇用户农村用户) {
    this.城镇用户农村用户 = 城镇用户农村用户;
    return this;
  }
  private String 出账周期;
  ...
  public BIGDATA_USER_INFO_S01 with_出账周期(String 出账周期) {
    this.出账周期 = 出账周期;
    return this;
  }
  private String 行业;
  ...
  public BIGDATA_USER_INFO_S01 with_行业(String 行业) {
    this.行业 = 行业;
    return this;
  }
  private String 高压低压;
  ...
  public BIGDATA_USER_INFO_S01 with_高压低压(String 高压低压) {
    this.高压低压 = 高压低压;
    return this;
  }
  private String 用户号;
  ...
  public BIGDATA_USER_INFO_S01 with_用户号(String 用户号) {
    this.用户号 = 用户号;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BIGDATA_USER_INFO_S01)) {
      return false;
    }
    BIGDATA_USER_INFO_S01 that = (BIGDATA_USER_INFO_S01) o;
    boolean equal = true;
  ...
  public Object clone() throws CloneNotSupportedException {
    BIGDATA_USER_INFO_S01 o = (BIGDATA_USER_INFO_S01) super.clone();
    return o;
  }
