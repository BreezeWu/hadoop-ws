...
//
// Debug information:
// Generated date: Fri Jul 04 16:48:40 CST 2014
...
public class BIGDATA_CHANGE_PAYTYPE_PY_S01 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public BIGDATA_CHANGE_PAYTYPE_PY_S01 with_用户ID(java.math.BigDecimal 用户ID) {
    this.用户ID = 用户ID;
    return this;
  }
  private String 年份;
  ...
  public BIGDATA_CHANGE_PAYTYPE_PY_S01 with_年份(String 年份) {
    this.年份 = 年份;
    return this;
  }
  ...
  public BIGDATA_CHANGE_PAYTYPE_PY_S01 with_缴费方式变更次数(java.math.BigDecimal 缴费方式变更次数) {
    this.缴费方式变更次数 = 缴费方式变更次数;
    return this;
  }
