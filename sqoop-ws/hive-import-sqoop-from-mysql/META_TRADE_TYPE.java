...
//
// Debug information:
// Generated date: Wed Jul 09 22:06:11 CST 2014
...
public class META_TRADE_TYPE extends SqoopRecord  implements DBWritable, Writable {
  ...
  public Integer get_SERIAL() {
    return SERIAL;
  }
  public void set_SERIAL(Integer SERIAL) {
    this.SERIAL = SERIAL;
  }
  public META_TRADE_TYPE with_SERIAL(Integer SERIAL) {
    this.SERIAL = SERIAL;
    return this;
  }
  ...
  private Integer TRADE_LEVEL;
  public Integer get_TRADE_LEVEL() {
    return TRADE_LEVEL;
  }
  public void set_TRADE_LEVEL(Integer TRADE_LEVEL) {
    this.TRADE_LEVEL = TRADE_LEVEL;
  }
  public META_TRADE_TYPE with_TRADE_LEVEL(Integer TRADE_LEVEL) {
    this.TRADE_LEVEL = TRADE_LEVEL;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.SERIAL = JdbcWritableBridge.readInteger(2, __dbResults);
    ...
    this.TRADE_LEVEL = JdbcWritableBridge.readInteger(9, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(SERIAL, 2 + __off, 4, __dbStmt);
    ...
    JdbcWritableBridge.writeInteger(TRADE_LEVEL, 9 + __off, 4, __dbStmt);
  ...
  public void readFields(DataInput __dataIn) throws IOException {
    ...
    this.SERIAL = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.TRADE = null;
    } else {
    ...
    this.TRADE_LEVEL = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.SUPER0 = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.SERIAL) { 
        ...
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.SERIAL);
    }
    if (null == this.TRADE) { 
        __dataOut.writeBoolean(true);
    } else {
    ...
    if (null == this.TRADE_LEVEL) { 
        ...
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.TRADE_LEVEL);
    }
    if (null == this.SUPER0) { 
        __dataOut.writeBoolean(true);
    } else {
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(SERIAL==null?"null":"" + SERIAL, delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(TRADE_LEVEL==null?"null":"" + TRADE_LEVEL, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.SERIAL = null; } else {
      this.SERIAL = Integer.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.TRADE_LEVEL = null; } else {
      this.TRADE_LEVEL = Integer.valueOf(__cur_str);
    }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("TRADE_CODE".equals(__fieldName)) {
      ...
      this.SERIAL = (Integer) __fieldVal;
    }
      ...
      this.TRADE_LEVEL = (Integer) __fieldVal;
    }
