...
//
// Debug information:
// Generated date: Wed Jul 09 21:56:43 CST 2014
...
public class BIGDATA_CHANGE_PAYTYPE_PY_S01 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public BIGDATA_CHANGE_PAYTYPE_PY_S01 with_cons_id(Integer cons_id) {
    this.cons_id = cons_id;
    return this;
  }
  private String y;
  ...
  private Integer change_payType_count;
  public Integer get_change_payType_count() {
    return change_payType_count;
  }
  public void set_change_payType_count(Integer change_payType_count) {
    this.change_payType_count = change_payType_count;
  }
  public BIGDATA_CHANGE_PAYTYPE_PY_S01 with_change_payType_count(Integer change_payType_count) {
    this.change_payType_count = change_payType_count;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.change_payType_count = JdbcWritableBridge.readInteger(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(change_payType_count, 3 + __off, 4, __dbStmt);
    return 3;
  }
  public void readFields(DataInput __dataIn) throws IOException {
    ...
    this.change_payType_count = Integer.valueOf(__dataIn.readInt());
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.change_payType_count) { 
        ...
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.change_payType_count);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(change_payType_count==null?"null":"" + change_payType_count, delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.change_payType_count = null; } else {
      this.change_payType_count = Integer.valueOf(__cur_str);
    }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("cons_id".equals(__fieldName)) {
      ...
      this.change_payType_count = (Integer) __fieldVal;
    }
    else {
